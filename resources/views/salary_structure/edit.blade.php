                ...
                <div class="col-sm-12">
                    ...
                    <!-- tab-pane -->
                        <div class="tab-pane" id="tab_salaryStructureTab">
                            <!-- Form Starts here -->
                            <form id="project_approval_handover" method="POST" action="{{ route('payroll.salary.structure.update', $salaryStructure->id) }}" >
                                {{ csrf_field() }}
                                @method('PATCH')
                                <div class="box-body jrf-form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="row field-changes-below">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="project_id" id="project_id" class="form-control" readonly>
                                                        <option value="{{ $salaryStructure->project->id }}" selected>{{ ucfirst($salaryStructure->project->name ) }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row field-changes-below">
                                                ...
                                                <div class="col-md-8">
                                                    <Select name="salary_cycle" id="salary_cycle" class="form-control input-sm basic-detail-input-style" readonly>
                                                        <option value="{{ $salaryStructure->salaryCycle->id }}" selected>{{ ucfirst($salaryStructure->salaryCycle->name) }}</option>
                                                    </Select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row field-changes-below">
                                                <div class="col-md-4 text-right">
                                                    <label for="pt_rate_applicable" class="basic-detail-label">PT-Rate Apply/Not Apply<span style="color: red">*</span></label>
                                                </div>
                                                <div class="col-md-8">
                                                    <Select name="pt_rate_applicable" id="pt_rate_applicable" class="form-control input-sm basic-detail-input-style" required>
                                                        <option selected value="1">Applied</option>
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        @foreach($earningSalaryHeads as $p)
                                            @if(in_array($p->id, $earningHeads))
                                                <tr>
                                                    <td><span class="text-bold">{{ ucfirst($p->name) }}</span></td>
                                                    <td>
                                                        <label class="t-check-container">
                                                            <input type="checkbox" class="singlecheckbox" value="{{ $p->id }}" name="earning_heads[]" checked>
                                                            <span class="task-checkmark"></span>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="t-check-container">
                                                            <?php $pfApplicable = \App\SalaryStructure::where('project_id', $salaryStructure->project_id)->where('salary_cycle_id', $salaryStructure->salary_cycle_id)->where('salary_head_id', $p->id)->first()->pf_applicable ?>
{{--                                                            @if($pfApplicable == 1)--}}
                                                                <input type="checkbox" class="singlecheckbox" value="1"  name="earning_head_pf_applicables[]" @if ($pfApplicable == 1) checked="checked" @endif>
{{--                                                            @else--}}
...
{{--                                                            @endif--}}
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        @foreach($deductionSalaryHeads as $p)
                                            @if(in_array($p->id, $deductionHeads))
                                                <tr>
                                                    <td><span class="text-bold">{{ ucfirst($p->name) }}</span></td>
                                                    <td>
                                                        <label class="t-check-container">
                                                            <input type="checkbox" class="singlecheckbox" value="{{ $p->id }}" name="deduction_heads[]" checked>
                                                            <span class="task-checkmark"></span>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="t-check-container">
                                                            <?php $pfApplicable = \App\SalaryStructure::where('project_id', $salaryStructure->project_id)->where('salary_cycle_id', $salaryStructure->salary_cycle_id)->where('salary_head_id', $p->id)->first()->pf_applicable ?>
                                                            @if($pfApplicable == 1)
                                                                <input type="checkbox" class="singlecheckbox" value="1" name="deduction_head_pf_applicables[]" checked>
                                                            @else
