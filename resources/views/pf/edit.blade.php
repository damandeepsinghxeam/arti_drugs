...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="fa fa-list"></i> Edit PF</h1>
            <ol class="breadcrumb">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="epf_percent" value="{{ $pf->epf_percent }}" id="" class="form-control experiencedata regis-input-field only_numeric" value="12" readonly>
                                        </div>
                                    ...
                                    <div class="form-group row col-md-12">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="pension_fund" value="{{ $pf->pension_fund }}" id="" class="form-control experiencedata regis-input-field only_numeric" step="0.01" min="-99.00" max="99.99">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="name" class="basic-detail-label">EPF(A-B) - (%)</label>
                                            <input type="number" name="epf_ab" value="{{ $pf->epf_ab }}" id="" class="form-control experiencedata regis-input-field only_numeric" step="0.01" min="-99.00" max="99.99">
                                        </div>
                                    ...
                                    <div class="form-group row col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="acc_no2" value="{{ $pf->acc_no2 }}" id="" class="form-control experiencedata regis-input-field only_numeric" step="0.01" min="-99.00" max="99.99">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="name" class="basic-detail-label">Acc. No. 21 - (%)</label>
                                            <input type="number" name="acc_no21" value="{{ $pf->acc_no21 }}" id="" class="form-control experiencedata regis-input-field only_numeric" step="0.01" min="-99.00" max="99.99">
                                        </div>
                                    ...
                                    <div class="form-group row col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="acc_no22" value="{{ $pf->acc_no22 }}" id="" class="form-control experiencedata regis-input-field only_numeric" step="0.01" min="-99.00" max="99.99">
                                        </div>
